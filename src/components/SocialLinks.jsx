...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/naman-harbola-3106a6322", // Add your LinkedIn URL
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@namanharbola", // Add your Instagram handle
    icon: Instagram,
    url: "https://www.instagram.com/naman_harbola3?igsh=OGRoZm5jbHl6NWps&utm_source=qr", // Add your Instagram URL
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@NamanHarbola",
    icon: Github,
    url: "https://github.com/NamanHarbola",
    color: "#ffffff",
